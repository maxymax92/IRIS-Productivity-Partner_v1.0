...
export const InlineCitationCarouselHeader = ({
  ...
  <div
    className={cn('bg-surface flex items-center justify-between gap-2 rounded-t-md p-2', className)}
    {...props}
  />
)
...
export const InlineCitationQuote = ({
  ...
  <blockquote
    className={cn(
      'border-accent-muted text-muted-foreground border-l-2 pl-3 text-sm italic',
      className,
    )}
    {...props}
  >
