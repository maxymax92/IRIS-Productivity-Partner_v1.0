...
export const PromptInputSelectTrigger = ({
  ...
  <SelectTrigger
    className={cn(
      ...
      'hover:bg-accent-bg hover:text-foreground aria-expanded:bg-accent-bg aria-expanded:text-foreground',
      className,
    )}
    {...props}
  />
...
export const PromptInputTabItem = ({ className, ...props }: PromptInputTabItemProps) => (
  <div
    className={cn('hover:bg-accent-bg flex items-center gap-2 px-3 py-2 text-xs', className)}
    {...props}
  />
)
