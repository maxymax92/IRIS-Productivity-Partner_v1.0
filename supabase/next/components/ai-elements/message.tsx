...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      'group-[.is-user]:bg-accent-bg group-[.is-user]:border-accent-muted/40 group-[.is-user]:text-foreground group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:border group-[.is-user]:px-4 group-[.is-user]:py-3',
